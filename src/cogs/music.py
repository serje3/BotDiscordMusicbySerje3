...
from src.voice_client import LavalinkVoiceClient
...
class Music(commands.Cog):
    def __init__(self, bot):
        ...
        if not hasattr(bot, 'lavalink'):  # This ensures the client isn't overwritten during cog reloads.
            ...
            bot.lavalink = lavalink.Client(716041669384077343)
            bot.lavalink.add_node('127.0.0.1', 2333, 'youshallnotpass', 'us',
                                  'default-node')  # Host, Port, Password, Region, Name
            print('node added?', bot.lavalink)
            print(bot.lavalink.node_manager.nodes[0].available)
